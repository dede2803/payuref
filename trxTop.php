...
function curl($url, $post = 0, $httpheader = 0, $proxy = 0)
{
    ...
    curl_setopt($ch, CURLOPT_COOKIEFILE, "s.txt");
    curl_setopt($ch, CURLOPT_COOKIEJAR, "s.txt");
...
if ($IP != "") {
    echo $WhiteTebal . "[18] SERVER TRX PAYU TOP";
    sleep(5);
    echo "\r                                                          \r";
    function head()
    {
    ...
    $login  = login($email, $token, array_merge(head(), array("Referer: https://trxpayu.top/?r=6310")));
    sleep(5);
    ...
    while (true) {
        for ($i = 0; $i < 500; $i++) {
            ...
            if ($sttsBal == "Empty") {
                echo $check2;
                echo $WhiteTebal . "[18] " . $YellowTebal . "TRX PAYU TOP " . $RedTebal . "Sedang Kosong. " . $WhiteTebal . "Tunggu Besok Lagi !!!\n";
                sleep(2);
            ...
            if ($alert == "danger") {
                echo $WhiteTebal . "[18] Claim" . $YellowTebal . "TRX PAYU TOP " . $RedTebal . "Habis. " . $WhiteTebal . "Tunggu Besok Lagi !!!\n";
                sleep(2);
                system("php trxXyz.php");
            } else {
                ...
                if ($aft == "") {
                    echo $WhiteTebal . "Server Trx Payu Top sedang " . $RedTebal . " Gangguan..!!!";
                    sleep(2);
                    echo "\r                                                                   \r";
                    sleep(2);
                    system("php trxXyz.php");
