...
function curl($url, $post = 0, $httpheader = 0, $proxy = 0)
{
    ...
    curl_setopt($ch, CURLOPT_COOKIEFILE, "i.txt");
...
if ($IP != "") {
    echo $WhiteTebal . "[9] SERVER DOGE PAYU TOP";
    sleep(5);
    echo "\r                                                          \r";
    function head()
    {
    ...
    $login  = login($email, $token, array_merge(head(), array("Referer: https://dogepayu.top/?r=3735")));
    sleep(5);
    ...
    while (true) {
        for ($i = 0; $i < 500; $i++) {
            ...
            if ($sttsBal == "Empty") {
                echo $check2;
                echo $WhiteTebal . "[9] " . $YellowTebal . "DOGE PAYU TOP " . $RedTebal . "Sedang Kosong. " . $WhiteTebal . "Tunggu Besok Lagi !!!\n";
                sleep(2);
            ...
            if ($alert == "danger") {
                echo $WhiteTebal . "[9] Claim" . $YellowTebal . "DOGE PAYU TOP " . $RedTebal . "Habis. " . $WhiteTebal . "Tunggu Besok Lagi !!!\n";
                sleep(2);
                system("php dogeXyz.php");
            } else {
                ...
                if ($aft == "") {
                    echo $WhiteTebal . "Server DOGE Payu Top sedang " . $RedTebal . " Gangguan..!!!";
                    sleep(2);
                    echo "\r                                                                   \r";
                    sleep(2);
                    system("php dogeXyz.php");
