...
if ($IP != "") {
    echo $WhiteTebal . "[13] SERVER FEY PAYU XYZ";
    sleep(5);
    echo "\r                                                          \r";
    function head()
    {
    ...
    {
        $ch = curl_init();
        curl_setopt($ch, CURLOPT_URL, "https://feypayu.xyz/faucet/currency/fey");
        curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
    ...
    function currency()
    {
        $url = "https://feypayu.xyz/faucet/currency/fey";
        return curl($url, '', head())[1];
    }

    function claim($aft, $ctn, $tkn, $header)
    {
        $url = "https://feypayu.xyz/faucet/verify/fey";
    ...
    $login  = login($email, $token, array_merge(head(), array("Referer: https://feypayu.xyz/?r=15")));
    sleep(5);
    ...
    while (true) {
        for ($i = 0; $i < 500; $i++) {
            ...
            if ($sttsBal == "Empty") {
                echo $check2;
                echo $WhiteTebal . "[13] " . $YellowTebal . "FEY PAYU XYZ " . $RedTebal . "Sedang Kosong. " . $WhiteTebal . "Tunggu Besok Lagi !!!\n";
                sleep(2);
                system("php ltcTop.php");
            }

            $alert = explode(' text-center">', explode('<div class="alert alert-', $currency)[1])[0];
            if ($alert == "danger") {
                echo $WhiteTebal . "[13] Claim" . $YellowTebal . "FEY PAYU XYZ " . $RedTebal . "Habis. " . $WhiteTebal . "Tunggu Besok Lagi !!!\n";
                sleep(2);
                system("php ltcTop.php");
            } else {
                ...
                if ($aft == "") {
                    echo $WhiteTebal . "Server FEY Payu Xyz sedang " . $RedTebal . " Gangguan..!!!";
                    sleep(2);
                    echo "\r                                                                   \r";
                    sleep(2);
                    system("php ltcTop.php");
                    ...
                    wktClaim($timeClaim);
                    sleep(2);
                    $claim = claim($aft, $ctn, $tkn, array_merge(head(), array("Referer: https://feypayu.xyz/faucet/currency/fey")));

                    echo $WhiteTebal . "Selamat, claim " . $GreenTebal . "BERHASIL.!!!";
                    sleep(2);
                    echo "\r                                                                \r";
                    sleep(2);
                    echo $WhiteTebal . "SERVER        = " . $YellowTebal . "FEY PAYU XYZ\n";
                    sleep(2);
