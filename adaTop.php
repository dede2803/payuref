...
if ($IP != "") {
    echo $WhiteTebal . "[1] SERVER ADA PAYU TOP";
    sleep(5);
    echo "\r                                                          \r";
    function head()
    {
    ...
    $login  = login($email, $token, array_merge(head(), array("Referer: https://adapayu.top/?r=390")));
    sleep(5);
    while (true) {
        for ($i = 0; $i < 500; $i++) {
            $check = test();
            ...
            if ($sttsBal == "Empty") {
                echo $check2;
                echo $WhiteTebal . "[1] " . $YellowTebal . "ADA PAYU TOP " . $RedTebal . "Sedang Kosong. " . $WhiteTebal . "Tunggu Besok Lagi !!!\n";
                sleep(2);
            ...
            if ($alert == "danger") {
                echo $WhiteTebal . "[1] Claim" . $YellowTebal . "ADA PAYU TOP " . $RedTebal . "Habis. " . $WhiteTebal . "Tunggu Besok Lagi !!!\n";
                sleep(2);
                system("php adaXyz.php");
            } else {
                ...
                if ($aft == "") {
                    echo $WhiteTebal . "Server Ada Payu Top sedang " . $RedTebal . " Gangguan..!!!";
                    sleep(2);
                    echo "\r                                                                   \r";
                    sleep(2);
                    system("php adaXyz.php");
