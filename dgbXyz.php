...
function curl($url, $post = 0, $httpheader = 0, $proxy = 0)
{
    ...
    curl_setopt($ch, CURLOPT_COOKIEFILE, "h.txt");
    curl_setopt($ch, CURLOPT_COOKIEJAR, "h.txt");
...
if ($IP != "") {
    echo $WhiteTebal . "[8] SERVER DGB PAYU XYZ";
    sleep(5);
    echo "\r                                                          \r";
    function head()
    {
    ...
    $login  = login($email, $token, array_merge(head(), array("Referer: https://dgbpayu.xyz/?r=10")));
    sleep(5);
    ...
    while (true) {
        for ($i = 0; $i < 500; $i++) {
            ...
            if ($sttsBal == "Empty") {
                echo $check2;
                echo $WhiteTebal . "[8] " . $YellowTebal . "DGB PAYU XYZ " . $RedTebal . "Sedang Kosong. " . $WhiteTebal . "Tunggu Besok Lagi !!!\n";
                sleep(2);
                system("php dogeTop.php");
            }

            $alert = explode(' text-center">', explode('<div class="alert alert-', $currency)[1])[0];
            if ($alert == "danger") {
                echo $WhiteTebal . "[8] Claim" . $YellowTebal . "DGB PAYU XYZ " . $RedTebal . "Habis. " . $WhiteTebal . "Tunggu Besok Lagi !!!\n";
                sleep(2);
                system("php dogeTop.php");
            } else {
                ...
                if ($aft == "") {
                    echo $WhiteTebal . "Server Dgb Payu Xyz sedang " . $RedTebal . " Gangguan..!!!";
                    sleep(2);
                    echo "\r                                                                   \r";
                    sleep(2);
                    system("php dogeTop.php");
