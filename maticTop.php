...
function curl($url, $post = 0, $httpheader = 0, $proxy = 0)
{
    ...
    curl_setopt($ch, CURLOPT_COOKIEFILE, "p.txt");
    curl_setopt($ch, CURLOPT_COOKIEJAR, "p.txt");
...
if ($IP != "") {
    echo $WhiteTebal . "[24] SERVER MATIC PAYU TOP";
    sleep(5);
    echo "\r                                                          \r";
    function head()
    {
    ...
    $login  = login($email, $token, array_merge(head(), array("Referer: https://maticpayu.top/?r=120")));
    sleep(5);
        ...
        for ($i = 0; $i < 500; $i++) {
            ...
            if ($check == "404") {
                ...
                if ($sttsBal == "Empty") {
                    ...
                    echo $check2;
                    echo $WhiteTebal . "[24] Coin " . $YellowTebal . "MATIC PAYU TOP " . $RedTebal . "Kosong. " . $WhiteTebal . "Tunggu Besok Lagi !!!\n";
                    sleep(2);
                    system("php solTop.php");
                } else {

                    $alert = explode(' text-center">', explode('<div class="alert alert-', $currency)[1])[0];
                    if ($alert == "danger") {
                        echo $WhiteTebal . "[24] Claim" . $YellowTebal . "MATIC PAYU TOP " . $RedTebal . "Habis. " . $WhiteTebal . "Tunggu Besok Lagi !!!\n";
                        sleep(2);
                        system("php solTop.php");
                    } else {
                        ...
                        $balance = explode(' MATIC</p>', explode('<p class="lh-1 mb-1 font-weight-bold">', $currency)[1])[0];
                        $totClaim = explode('</p>', explode('<p class="lh-1 mb-1 font-weight-bold">', $currency)[3])[0];

                        if ($aft == "") {
                            echo $WhiteTebal . "SERVER MATIC PAYU TOP sedang " . $RedTebal . " Gangguan..!!!";
                            sleep(2);
                            echo "\r                                                                   \r";
                            sleep(2);
                            system("php solTop.php");
                            ...
                            sleep(2);
                            echo $WhiteTebal . "Telah dikirim = " . $GreenTebal . "" . $balance . " MATIC\n";
                            sleep(2);
