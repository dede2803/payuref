...
function curl($url, $post = 0, $httpheader = 0, $proxy = 0)
{
    ...
    curl_setopt($ch, CURLOPT_COOKIEFILE, "q.txt");
    curl_setopt($ch, CURLOPT_COOKIEJAR, "q.txt");
...
if ($IP != "") {
    echo $WhiteTebal . "[16] SERVER SOL PAYU TOP";
    sleep(5);
    echo "\r                                                          \r";
    function head()
    {
    ...
    $login  = login($email, $token, array_merge(head(), array("Referer: https://solpayu.top/?r=4630")));
    sleep(5);
    ...
    while (true) {
        for ($i = 0; $i < 500; $i++) {
            ...
            if ($sttsBal == "Empty") {
                echo $check2;
                echo $WhiteTebal . "[16] " . $YellowTebal . "SOL PAYU TOP " . $RedTebal . "Sedang Kosong. " . $WhiteTebal . "Tunggu Besok Lagi !!!\n";
                sleep(2);
            ...
            if ($alert == "danger") {
                echo $WhiteTebal . "[16] Claim" . $YellowTebal . "SOL PAYU TOP " . $RedTebal . "Habis. " . $WhiteTebal . "Tunggu Besok Lagi !!!\n";
                sleep(2);
                system("php solXyz.php");
            } else {
                ...
                if ($aft == "") {
                    echo $WhiteTebal . "Server SOL Payu Top sedang " . $RedTebal . " Gangguan..!!!";
                    sleep(2);
                    echo "\r                                                                   \r";
                    sleep(2);
                    system("php solXyz.php");
