...
function curl($url, $post = 0, $httpheader = 0, $proxy = 0)
{
    ...
    curl_setopt($ch, CURLOPT_COOKIEFILE, "n.txt");
    curl_setopt($ch, CURLOPT_COOKIEJAR, "n.txt");
...
if ($IP != "") {
    echo $WhiteTebal . "[14] SERVER LTC PAYU TOP";
    sleep(5);
    echo "\r                                                          \r";
    function head()
    {
    ...
    $login  = login($email, $token, array_merge(head(), array("Referer: https://ltcpayu.top/?r=12")));
    sleep(5);
    ...
    while (true) {
        for ($i = 0; $i < 500; $i++) {
            ...
            if ($sttsBal == "Empty") {
                echo $check2;
                echo $WhiteTebal . "[14] " . $YellowTebal . "LTC PAYU TOP " . $RedTebal . "Sedang Kosong. " . $WhiteTebal . "Tunggu Besok Lagi !!!\n";
                sleep(2);
            ...
            if ($alert == "danger") {
                echo $WhiteTebal . "[14] Claim" . $YellowTebal . "LTC PAYU TOP " . $RedTebal . "Habis. " . $WhiteTebal . "Tunggu Besok Lagi !!!\n";
                sleep(2);
                system("php ltcXyz.php");
            } else {
                ...
                if ($aft == "") {
                    echo $WhiteTebal . "Server LTC PAYU TOP sedang " . $RedTebal . " Gangguan..!!!";
                    sleep(2);
                    echo "\r                                                                   \r";
                    sleep(2);
                    system("php ltcXyz.php");
